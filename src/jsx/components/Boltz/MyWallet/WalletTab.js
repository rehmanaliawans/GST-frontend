...
const CompleteLink = () =>{
	return(
		<Link to={"#"} className="btn-link text-success float-end" >Completed</Link>
	)
}
const CanceleLink = () =>{
	return(
		<Link to={"#"} className="btn-link text-danger float-end" >Canceled</Link>
	)
}
const PendingLink = () =>{
	return(
		<Link to={"#"} className="btn-link text-light float-end" >Pending</Link>
	)
}
const Downarrow = () =>{
	return(
						...
						<TabContent activeTab={activeTab}>
							<TabPane tabId="1">
								<div className="table-responsive">
									<table className="table border-hover tr-rounded card-table  tbl-btn short-one">
										<tbody>
