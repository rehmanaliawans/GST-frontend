      ...
      <Row>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#2258bf"  />
                <SparklinesReferenceLine type="mean" color="#2258bf"/>
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#2258bf"  style={{ fill: "none" }} />
                <SparklinesSpots />
              </Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#2258bf" />
                <SparklinesSpots style={{ fill: "#2258bf" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
		<Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData} >
				<SparklinesBars style={{ fill: '#2258bf', fillOpacity: ".6" }} />
				<SparklinesReferenceLine />
			</Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              ...
              >
                <SparklinesBars style={{ fill: "#2258bf" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
